 ...
 */
public class WinnerProgress30s extends AppWidgetProvider {
    private static final String TAG = "WinnerProgress30s";
    private static final String PREFS_NAME = "signal_noise_widget_data";
    private static final String ACTION_AUTO_UPDATE = "app.signalnoise.twa.AUTO_UPDATE_PROGRESS30s";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ACTION_AUTO_UPDATE.equals(intent.getAction())) {
            ...
            int[] appWidgetIds = appWidgetManager.getAppWidgetIds(
                new android.content.ComponentName(context, WinnerProgress30s.class));
    ...
    private void setupAutoRefresh(Context context, int appWidgetId) {
        try {
            ...
            Intent intent = new Intent(context, WinnerProgress30s.class);
