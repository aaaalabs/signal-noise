              ...
              <div class="invoice-section">
                <div class="invoice-card">
                  ...
                  <div class="invoice-body">
                    ...
                    <a href="https://signal-noise.app/invoice/secure/${invoiceToken}" class="invoice-link">
...
Your payment receipt is available at: https://signal-noise.app/invoice/secure/${invoiceToken}
...
/**
 * Send welcome email for promo code users (without invoice)
 */
export const sendPromoWelcomeEmail = async (
  userEmail,
  firstName,
  tierName = 'Product Hunt Early Access',
  expiryDate = 'October 31, 2025'
) => {
  try {
    console.log(`Sending promo welcome email to ${userEmail}`);
      ...
      <body>
        <div class="email-container">
          <div class="header">
            ...
            <h1 class="brand-title">Signal/Noise</h1>
            <p class="brand-subtitle">Early Access Activated!</p>
          </div>
          ...
          <div class="content">
            <div class="content-card">
              <h2 class="greeting">Hi ${firstName || 'there'}!</h2>
              <p class="message">
                Welcome to Signal/Noise! Your exclusive early access is now active. Experience the full power of AI-guided productivity and discover what true focus feels like.
              </p>
              ...
              <div class="promo-badge">
                ...
                <div class="promo-title">${tierName}</div>
                <p class="promo-text">
                  Full premium access to all features.<br>
                  No payment required. No credit card needed.
                </p>
                <div class="expiry-notice">
                  Valid until <span class="expiry-date">${expiryDate}</span>
                </div>
              </div>
              ...
              <div class="features-section">
                ...
                <div class="features-grid">
                  <div class="feature-item">
                    ...
                    <div class="feature-content">
                      <div class="feature-title">Personal AI Coach</div>
                      <div class="feature-description">Get instant productivity insights powered by Groq</div>
                    </div>
                  </div>
                  <div class="feature-item">
                    <span class="feature-icon">
                    ...
                    <div class="feature-content">
                      <div class="feature-title">Track Your Signal Ratio</div>
                      <div class="feature-description">Monitor your focus on what truly matters</div>
                    </div>
                  </div>
                  <div class="feature-item">
                    <span class="feature-icon">
                    ...
                    <div class="feature-content">
                      <div class="feature-title">Pattern Recognition</div>
                      <div class="feature-description">Discover your peak productivity patterns</div>
                    </div>
                  </div>
                  <div class="feature-item">
                    <span class="feature-icon">
                    ...
                    <div class="feature-content">
                      <div class="feature-title">Daily Check-ins</div>
                      <div class="feature-description">Stay accountable with smart notifications</div>
                    </div>
                  </div>
                  <div class="feature-item">
                    <span class="feature-icon">
                    ...
                    <div class="feature-content">
                      ...
                      <div class="feature-description">Unlock badges as you improve your focus</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="footer">
            <p class="footer-text">
              This early access was granted through our Product Hunt pre-launch campaign.<br>
              Enjoy full premium features until ${expiryDate}.
            </p>
            <p class="footer-brand">
              Signal/Noise<br>
              <a href="https://signal-noise.app" class="footer-link">signal-noise.app</a>
    ...
    const text = `
Signal/Noise - Early Access Activated!

Hi ${firstName || 'there'}!

Welcome to Signal/Noise! Your exclusive early access is now active.
...
What You Can Do Now:
• Personal AI Coach - Get instant productivity insights powered by Groq
• Track Your Signal Ratio - Monitor your focus on what truly matters
• Pattern Recognition - Discover your peak productivity patterns
• Daily Check-ins - Stay accountable with smart notifications
• Achievement System - Unlock badges as you improve your focus

Start Your Focus Journey: https://signal-noise.app

This early access was granted through our Product Hunt pre-launch campaign.
Enjoy full premium features until ${expiryDate}.
...
https://signal-noise.app
    ...
    const response = await resend.emails.send({
      from: FROM_ADDRESS,
      to: userEmail,
      subject: 'Signal/Noise Early Access Activated!',
      html,
      text,
      tags: [
        { name: 'category', value: 'promo_welcome' },
        { name: 'tier', value: 'product_hunt_early_access' },
        { name: 'promo', value: 'true' }
      ]
    });

    if (response.error) {
      console.error('Resend promo welcome email error:', response.error);
      return {
        success: false,
        error: response.error.message
      };
    ...
    console.log(`Promo welcome email sent: ${response.data?.id}`);
    return {
      success: true,
      messageId: response.data?.id
    };
